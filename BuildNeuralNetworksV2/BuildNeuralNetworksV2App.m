classdef BuildNeuralNetworksV2App < handle
%
% Usage:
%     app.BuildNeuralNetworksV2App

  properties
      AppPath = {'/BuildNeuralNetworksV2'};
	  AppClass = 'BuildNeuralNetworksV2App';
	  AppHandle;
	  AppCount = 0;
      Increment = 1;
	  Decrement = 0;
  ...
  methods
    ...
    function obj = BuildNeuralNetworksV2App()      
    ...
    function startApp(obj)
        ...
        if nargout(@build_neural) == 0  
            eval('build_neural');
        else
			obj.AppHandle = eval('build_neural');   
        end 
        % Increment the reference count by one    
        BuildNeuralNetworksV2App.refcount(obj.Increment);
