function [] = print_VHDL_multipliers_singleLUT(neural, normalized_list, ~,...
                          ~, N_ROWS, accuracy, RTS_bits, ...
                          ~, mean_value, std_dev, trigger_CLK,...
                          switch_criteria, switch_enable,No_train_enable, index)
...
fprintf(fid3,'      reset           : IN  STD_LOGIC;\n');
...
fprintf(fid6,'  signal ann_stop            : STD_LOGIC;\n');
...
fprintf(fid6,'        FOR i IN 1 to %d LOOP\n',N_INPUTS);
...
fprintf(fid7,'          misses := misses + counter - 1;\n');
...
% Print VHDL code for Final Testbench
fprintf(fid10,'------------------------------------------------\n');
