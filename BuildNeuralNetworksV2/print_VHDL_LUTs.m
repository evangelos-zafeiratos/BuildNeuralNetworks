function [] = print_VHDL_LUTs(neural, normalized_list, binary_list, compressed_list, ...
                          N_ROWS, accuracy, RTS_bits, compressed_RTS_bits,...
                          ~, ~, trigger_CLK, switch_criteria, switch_enable)
...
for i = 1:N_OUTPUTS
 ...
 fprintf(fid,'-- the dataset is such that allows this modification.\n');
 ...
 fprintf(fid3,'-- constants: "UPPER_LIMIT" and "DOWN_LIMIT". The latter \n');
 ...
 fprintf(fid3,'  subtype small_integer IS INTEGER RANGE 0 TO 31;\n');
...
fprintf(fid7,'        WHEN first =>                    -- Read inputs and outputs from the respective .txt files\n');
...
fprintf(fid7,'          wait_counter <= latency + 3;\n');
fprintf(fid7,'          num_cases    <= num_cases +1;\n');
fprintf(fid7,'          state        <= second;\n');
fprintf(fid7,'        WHEN second =>                     -- Evaluate the results and print appropriate error messages in the console.\n');
fprintf(fid7,'          FOR i IN 1 to N_OUTPUTS LOOP\n');
